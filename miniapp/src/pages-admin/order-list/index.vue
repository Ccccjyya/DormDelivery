...
<style scoped>
.admin-order-page{height:100vh;display:flex;flex-direction:column;overflow:hidden}.order-header{flex:0 0 auto}.title{margin-bottom:0}.menu-button{width:auto;min-width:112rpx;margin:0;padding:0 24rpx;background:#edf5f2;color:#1d5b50;font-size:26rpx;border-radius:6px}.menu-button::after{border:0}.filter-row{display:flex;align-items:center;justify-content:space-between;min-height:84rpx;padding:0 20rpx;margin-bottom:18rpx;border:1rpx solid #deebe7;border-radius:6px;background:#fff}.filter-label{color:#52635e;font-size:27rpx}.filter-picker{min-width:180rpx;color:#147a69;text-align:right;font-size:27rpx}.order-content{flex:1;min-height:0;box-sizing:border-box}.image-list{display:flex;flex-wrap:wrap;gap:12rpx;margin:12rpx 0}.order-image{width:144rpx;height:144rpx;border-radius:6px}.empty{min-height:100%;display:flex;align-items:center;justify-content:center;padding:0}.loading-state{min-height:120rpx}.error-state{text-align:center;color:#a02b2b;padding:60rpx 0}.retry{width:220rpx;margin-top:20rpx;font-size:26rpx}.end{text-align:center;color:#6a7d76;padding:24rpx}
</style>
