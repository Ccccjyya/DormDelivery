...
<style scoped>.editor{padding-bottom:20rpx}.field-label{margin-bottom:10rpx;font-weight:600}.textarea{width:100%;height:280rpx;padding:20rpx;border:1px solid #C9DFF2;border-radius:6px;box-sizing:border-box}.publish-button{color:#fff}.section-title{font-size:32rpx;font-weight:600;margin:30rpx 0 16rpx}.item-title{font-weight:600;min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.error-state{text-align:center;color:#b42318;padding:70rpx 0}.retry{width:220rpx;margin-top:20rpx;font-size:26rpx}.end{text-align:center;color:#7A93A8;padding:24rpx}</style>
