...
<style scoped>.rule-item{width:100%;min-height:92rpx;display:flex;align-items:center;justify-content:space-between;box-sizing:border-box;padding:20rpx 24rpx;margin-bottom:16rpx;background:#fff;border:1rpx solid #D8E9F7;border-radius:8px}.rule-title{min-width:0;flex:1;font-weight:600;font-size:29rpx}.arrow{flex-shrink:0;margin-left:18rpx;color:#7A93A8;font-size:42rpx}.error-state{text-align:center;color:#b42318;padding:70rpx 0}.retry{width:220rpx;margin-top:20rpx;font-size:26rpx}</style>
