...
<style scoped>
.tabs{display:flex;gap:12rpx;margin-bottom:20rpx}.tab{flex:1;min-width:0;height:80rpx;padding:0 8rpx;background:#edf5f2;color:#1d5b50;font-size:26rpx}.tab.active{background:#147a69;color:#fff}.tab::after{border:0}.stats{line-height:1.7}.stat-row{display:flex;align-items:center;justify-content:space-between;gap:20rpx;padding:14rpx 0}.stat-row text:first-child{min-width:0;flex:1}.stat-row text:last-child{flex:none}.rate{text-align:center;margin-top:24rpx;padding-top:22rpx;border-top:1rpx solid #deebe7;font-size:34rpx;font-weight:700;color:#147a69}.error-state{text-align:center;color:#b42318;padding:70rpx 0}.retry{width:220rpx;margin-top:20rpx;font-size:26rpx}
</style>
